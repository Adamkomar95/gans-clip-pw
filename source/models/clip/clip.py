"""
Oficjalne repo openai https://github.com/openai/CLIP/blob/main/clip/clip.py
Zostawiłem na ten moment tylko Vit-B/32 model wykorzystywany w większości przypadków.

Mamy tu 3 części:
- pobieranie gotowych modeli
- definicje samego modelu
- tokenizer do CLIPa
"""
