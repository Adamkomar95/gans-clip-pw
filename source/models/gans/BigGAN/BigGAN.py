"""
Implementacja BigGAN z repo https://github.com/huggingface/pytorch-pretrained-BigGAN z małymi zmianami.

W dużym skrócie:

SelfAttn + BigGanBatchNorm + GenBlock -> Generator -> BigGan (+BigGanConfig)

Explaination: https://medium.com/analytics-vidhya/key-concepts-of-biggan-training-and-assessing-large-scale-image-generation-4c8303dcf73f
...
from source.models.gans.BigGAN.utils import cached_path
from source.models.gans.BigGAN.config import BigGANConfig
